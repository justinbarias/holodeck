...
>
> **Superseded twice.** First by `docs/product-specs/036-deterministic-spine/spec.md`
...
> primitives. The authoritative spec is now `docs/product-specs/040-holodeck-temporal/spec.md`
