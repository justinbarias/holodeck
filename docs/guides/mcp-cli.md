...
**Solution:** Use a server that offers stdio, sse, or http, or run the agent on the Claude backend. See the [OpenAI backend guide](openai-backend.md) for backend-specific transport behavior.
