...
**Builds on:** `docs/product-specs/033-holodeck-test-optimizer/` (coordinate-descent optimizer, shipped in PR #335)
...
docs/product-specs/037-gepa-optimizer/   # this spec + plan/tasks to follow
