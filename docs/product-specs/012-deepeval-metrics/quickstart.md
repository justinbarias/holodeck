...
- See [Data Model](../../design-docs/012-deepeval-metrics/data-model.md) for detailed entity definitions
- See [Contracts](contracts/evaluator_interfaces.md) for full API documentation
- See [Research](../../design-docs/012-deepeval-metrics/research.md) for implementation rationale
