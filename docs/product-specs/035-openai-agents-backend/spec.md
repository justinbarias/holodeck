...
**Related**: `docs/product-specs/023-choose-your-backend`, `docs/product-specs/024-claude-serve-deploy`, `docs/product-specs/025-tool-init-endpoints`, `docs/product-specs/026-sdk-config-additions`, `docs/product-specs/027-mcp-http-sse-transport`, `docs/product-specs/028-yaml-hooks-system`, `docs/product-specs/029-subagent-orchestration`, `docs/product-specs/030-skills-support`, `docs/product-specs/034-production-hardening/2026-05-18-production-hardening-for-claude-agents.md`
