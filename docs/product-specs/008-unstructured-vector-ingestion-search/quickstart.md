...
- [Data model reference](../../design-docs/008-unstructured-vector-ingestion-search/data-model.md)
- [Implementation research](../../design-docs/008-unstructured-vector-ingestion-search/research.md)
- [Example agents](../../../src/holodeck/templates/)
