...
### HoloDeck Resources
- **Feature Specification**: `docs/product-specs/009-ollama-endpoint-support/spec.md`
- **Data Model**: `docs/design-docs/009-ollama-endpoint-support/data-model.md`
- **Configuration Schema**: `docs/product-specs/009-ollama-endpoint-support/contracts/ollama-config-schema.md`
