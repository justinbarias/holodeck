...
- [ ] **E1 — Schema + docs for the new config.**
  ...
  **Files:** `schemas/agent.schema.json`, `docs/guides/evaluations.md`, `AGENTS.md`,
  `docs/product-specs/033-holodeck-test-optimizer/optimizer.md`.
  **Scope:** S–M.
...
- [ ] **E2 — Refresh stale predecessor docs.**
  ...
  **Files:** `docs/product-specs/033-holodeck-test-optimizer/{plan,tasks,plan-text-proposer,tasks-text-proposer}.md`.
  **Scope:** XS.
