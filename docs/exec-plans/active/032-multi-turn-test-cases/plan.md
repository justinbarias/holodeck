...
**Branch**: `032-multi-turn-test-cases` | **Date**: 2026-04-20 | **Spec**: [spec.md](../../../product-specs/032-multi-turn-test-cases/spec.md)
**Input**: Feature specification from `/docs/product-specs/032-multi-turn-test-cases/spec.md`
...
```text
docs/product-specs/032-multi-turn-test-cases/
├── plan.md              # This file
...
4. **Documentation update** — document `ExecutionConfig.parallel_test_cases`, the `Turn`/`TurnResult` models, built-in deterministic evaluators, and the code-grader contract in the linked feature documents. Keep the `AGENTS.md` map current and preserve `CLAUDE.md` as its single import.
...
Follow this order when breaking down the implementation tasks:
