...
**Input**: `/docs/product-specs/032-multi-turn-test-cases/` — spec.md (US3), data-model.md §2–§3, contracts/test-case-schema.md §3–§4, contracts/tool-arg-matchers.md (authoritative for SC-006 matrix).
