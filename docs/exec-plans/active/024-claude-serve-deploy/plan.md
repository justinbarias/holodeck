...
**Branch**: `024-claude-serve-deploy` | **Date**: 2026-03-20 | **Spec**: [spec.md](../../../product-specs/024-claude-serve-deploy/spec.md)
**Input**: Feature specification from `/docs/product-specs/024-claude-serve-deploy/spec.md`
...
```text
docs/product-specs/024-claude-serve-deploy/
├── plan.md              # This file
