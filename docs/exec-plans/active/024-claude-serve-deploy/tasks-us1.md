...
**Spec**: [spec.md](../../../product-specs/024-claude-serve-deploy/spec.md) | **Plan**: [plan.md](plan.md) | **Data Model**: [data-model.md](../../../design-docs/024-claude-serve-deploy/data-model.md)
...
3. **Contract compliance**: REST error responses (502 for crashes, 503 for capacity) and AG-UI SSE error events MUST match the contracts defined in `/Users/justinbarias/Documents/Git/python/agentlab/docs/product-specs/024-claude-serve-deploy/contracts/session-cap.md` exactly.
