...
- [ ] TPOL0 [P] Commit `docs/design-docs/031-eval-runs-dashboard/visual-baselines/` — screenshots + `dashboard_tour.gif` captured via Chrome MCP during US4/US5 Phase 8. These are the durable visual-parity evidence against the handoff prototype
...
- Every task uses the strict checklist format: `- [ ] TID [P?] [US#] description with file path`.
