...
Record in `docs/product-specs/034-production-hardening/2026-05-18-production-hardening-for-claude-agents.md` under the Phase 4 section:
...
```bash
git add docs/product-specs/034-production-hardening/2026-05-18-production-hardening-for-claude-agents.md
...
- Spike data and design recorded in `docs/product-specs/034-production-hardening/2026-05-18-production-hardening-for-claude-agents.md` Phase 4.
