...
This task does **not** write production code. It produces a 1–2 page memo (`docs/product-specs/034-production-hardening/2026-05-24-spec-034-p3-baseurl-spike.md`) that confirms or rejects three assumptions the rest of the plan depends on.
...
**Acceptance criteria:**
- [ ] Memo committed under `docs/product-specs/034-production-hardening/`.
...
**Files:**
- Modify: `docs/product-specs/034-production-hardening/2026-05-18-production-hardening-for-claude-agents.md` (status table)
...
**Files:**
- Create: `docs/product-specs/034-production-hardening/2026-05-24-spec-034-p3-followup-cloud-auth.md` (one-page stub)
