...
**Branch**: `021-claude-agent-sdk` | **Date**: 2026-02-20 | **Spec**: [spec.md](../../../product-specs/021-claude-agent-sdk/spec.md)
**Input**: Feature specification from `/docs/product-specs/021-claude-agent-sdk/spec.md`
...
```text
docs/product-specs/021-claude-agent-sdk/
├── plan.md              # This file
