...
**Branch**: `017-agent-local-server` | **Date**: 2025-12-29 | **Spec**: [spec.md](../../../product-specs/017-agent-local-server/spec.md)
**Input**: Feature specification from `/docs/product-specs/017-agent-local-server/spec.md`
...
```text
docs/product-specs/017-agent-local-server/
├── plan.md              # This file
...
Write implementation tasks from this plan.
