...
Build the four deliverables of `docs/product-specs/040-holodeck-temporal/spec.md`: an
...
- [x] `make ci` clean; spec status updated in `docs/product-specs/inventory.md` — merged to main 2026-08-30 (stack #369)
...
* **Python developer** — activity factory (`agent_activity`), typed payloads
  ...
  2026-08-30, recorded in docs/product-specs/041-temporal-file-inputs/spec.md §4).
...
`sample/temporal-hardship/` (git-ignored). Update `docs/product-specs/inventory.md` row 040
and the spec status line. Docsite content moved to T17.

**Acceptance criteria:**
- [x] Smoke test passes manually with credentials
- [x] `docs/product-specs/inventory.md` row reflects final task count and status
...
**Files likely touched:** `tests/integration/temporal/test_smoke_live.py`, `docs/…`, `docs/product-specs/inventory.md`, `docs/product-specs/040-holodeck-temporal/spec.md`
**Estimated scope:** S
...
history; implementation tracking lives in `docs/product-specs/041-temporal-file-inputs/`.
