...
**Branch**: `023-choose-your-backend` | **Date**: 2026-03-15 | **Spec**: [spec.md](../../../product-specs/023-choose-your-backend/spec.md)
**Input**: Feature specification from `/docs/product-specs/023-choose-your-backend/spec.md`
...
```text
docs/product-specs/023-choose-your-backend/
├── plan.md              # This file
