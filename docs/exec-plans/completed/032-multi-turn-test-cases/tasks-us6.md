...
**Input**: `/docs/product-specs/032-multi-turn-test-cases/` — spec.md (US6), quickstart.md (ConvFinQA example), contracts/test-case-schema.md, contracts/code-grader-contract.md. Source dataset: `/Users/justinbarias/Documents/Git/python/justinbarias/data/convfinqa_dataset.json` (21 MB, `{"train": [...], "dev": [...]}` shape — verified).
...
- [x] T020 [US6] Write `sample/financial-assistant/claude/README.md` (target ≤ 350 words — SC-001 time budget):
  ...
  - Cross-reference `docs/product-specs/032-multi-turn-test-cases/quickstart.md` for the full feature tutorial.
