...
> banner in `spec.md` and the successor `docs/product-specs/040-holodeck-temporal/spec.md`.


> Sources: `docs/product-specs/036-deterministic-spine/spec.md` + `refinements.md` (binding
...
**Dependencies:** None · **Files:** `pyproject.toml`, `tests/unit/workflow/test_feel_conformance.py`, `docs/design-docs/036-deterministic-spine/research.md` · **Scope:** S
...
Source documents are pinned in `docs/product-specs/039-policy-generator/corpus/` with hashes
...
`docs/product-specs/039-policy-generator/` — AI-drafted decision tables and `workflow.yaml`
...
`docs/product-specs/039-policy-generator/corpus-manifest.md`.
