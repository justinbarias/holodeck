...
**Spec:** `docs/product-specs/038-optimizer-progress-stream/spec.md`
...
| Plan/task location | `docs/product-specs/038-optimizer-progress-stream/` | This file + `tasks.md`, beside `spec.md`, matching siblings 033/037. |
