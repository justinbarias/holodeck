...
**Branch**: `020-structured-document-tool` | **Date**: 2026-01-29 | **Spec**: [spec.md](../../../product-specs/020-structured-document-tool/spec.md)
**Input**: Feature specification from `/docs/product-specs/020-structured-document-tool/spec.md`
...
```text
docs/product-specs/020-structured-document-tool/
├── plan.md              # This file
