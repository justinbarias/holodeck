...
**Branch**: `022-otel-genai-semconv` | **Date**: 2026-03-01 | **Spec**: [spec.md](../../../product-specs/022-otel-genai-semconv/spec.md)
**Input**: Feature specification from `/docs/product-specs/022-otel-genai-semconv/spec.md`
...
```text
docs/product-specs/022-otel-genai-semconv/
├── plan.md              # This file
