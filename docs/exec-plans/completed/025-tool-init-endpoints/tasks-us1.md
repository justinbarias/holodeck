...
**Date**: 2026-03-24
**Spec**: [spec.md](../../../product-specs/025-tool-init-endpoints/spec.md) | **Plan**: [plan.md](plan.md) | **Data Model**: [data-model.md](../../../design-docs/025-tool-init-endpoints/data-model.md)
