...
4. Approval MUST include verification that affected specifications, design
   documents, and execution plans are updated or explicitly exempted
...
- Every feature specification MUST include a Constitution Check section
  that records compliance or justified exceptions
...
configuration, etc.) are documented in [Contributing](../contributing.md)
and the [Makefile](../../Makefile). [AGENTS.md](../../AGENTS.md) maps the
engineering guidance. This Constitution establishes product principles.

**Version**: 1.0.2 | **Ratified**: 2025-10-19 | **Last Amended**: 2026-09-06

The 1.0.2 revision relocates this document and updates workflow references.
The five core principles are unchanged.
