# Unstructured Vector Ingestion & Search — design records

Feature: `008-unstructured-vector-ingestion-search`. Status and task evidence: [feature inventory](../../product-specs/inventory.md).
